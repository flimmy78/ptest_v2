...
#define GPIO_NAME_ACC_CTL   "acc_ctl"
...
static struct gpio GPIO[] = {
    ...
    GPIO_INIT(GPIO_NAME_ACC_CTL,  GPIO_NUMBER_ACC_CTL,  GPIO_W),
    ...
    GPIO_INIT(GPIO_NAME_SHUT,  GPIO_NUMBER_SHUT,  GPIO_W),
